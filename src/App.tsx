    ...
    <>
      ...
      <main>
        ...
        <section id='projects'>
          <h1>Projects</h1>
          <p>
            This is a placeholder text for the About section of the portfolio. Replace
            it with your own content and components.
          </p>
          <p>
            This is a placeholder text for the About section of the portfolio. Replace
            it with your own content and components.
        ...
        <section id='skills'>
          <h1>Projects</h1>
          <p>
            This is a placeholder text for the Projects section of the portfolio.
            Replace it with your own content and components.
          </p>
          <p>
            This is a placeholder text for the About section of the portfolio. Replace
            it with your own content and components.
        ...
        <section id='contact'>
          <h1>Contact</h1>
          <p>
            This is a placeholder text for the Contact section of the portfolio.
            Replace it with your own content and components.
          </p>
          <p>
            This is a placeholder text for the About section of the portfolio. Replace
