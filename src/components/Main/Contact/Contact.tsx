                    ...
                    <div id="gh_left" >
                        <div className="contact_block">
                            <a href='https://github.com/tranquochuy645' target='_blank' rel='noopener noreferrer'>
                                <img alt="Github" className="provider-logo" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original-wordmark.svg" />
                            </a>
                            <p><a className="white none-decoration-exhov text_wrap_break_word" href="https://github.com/tranquochuy645" aria-label="HCMUTE website">https://github.com/tranquochuy645</a></p>
                        </div>
                        <img id="contribution-chart" src="https://ghchart.rshah.org/39BD00/tranquochuy645" alt="Huy's contributions this year"></img>
                    </div>
                    <img alt="prefered langs" id="prefered-langs" src="https://github-readme-stats.vercel.app/api/top-langs?username=tranquochuy645&langs_count=8&layout=donut&hide_border=true&bg_color=00000000&title_color=fff&text_color=fff" />
                </div>
            </div>
        </>
    );
