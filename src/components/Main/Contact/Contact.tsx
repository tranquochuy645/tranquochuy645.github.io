            ...
            <div className='contact_info floating-bg'>
                <div id='contact_info_basic'>
                    <div className="contact_block">
                        ...
                        <a className="green text_wrap_break_word none-decoration-exhov" aria-label="Mail" href="mailto:tranquochuy645@gmail.com">
                    ...
                    <div className="contact_block">
                        ...
                        <p className='green'>
                            ...
                            <a className="green text_wrap_break_word none-decoration-exhov" aria-label="Tel" href="tel:+84378258645">
                                +84 37 825 8645
                            </a>
                        </p>
                        <img className="cpy-clipboard" alt="copy to clipboard"
                ...
                <div id="gh-short">
                    ...
                    <img alt="prefered langs" id="prefered-langs" src="https://github-readme-stats.vercel.app/api/top-langs?username=tranquochuy645&langs_count=8&layout=donut&hide_border=true&bg_color=00000000&title_color=25ff2c&text_color=fff" />
                </div>
            </div>
        </>
    );
