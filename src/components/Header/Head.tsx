...
const Head = () => {
    function dropDownNav() {
        document.querySelector(".menu-btn-wrapper")?.classList.toggle("opened");
        document.querySelector("ul")?.classList.toggle("opened");
    }
    return (
        <header>
            <div>
                <a href="#landing" aria-label="Landing section">
                ...
                <ul>
                    <li><a href="#projects" aria-label="Projects section"><img src='/assets/project.svg' />&nbsp;Projects</a></li>
                    <li><a href="#skills" aria-label="Skills section"><img src='/assets/tool.svg' />&nbsp;Skills</a></li>
                    <li><a href="#contact" aria-label="Contact section"><img src='/assets/contact.svg' />&nbsp;Contact</a></li>
                </ul>
            </div>
            <div className='menu-btn-wrapper' onClick={dropDownNav}>
